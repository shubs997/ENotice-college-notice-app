          ...
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="updateuser.jsp" class="list-group-item"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Update My Profile <span class="badge">#</span></a>
                  ...
                  <form action="dispcircular" method="POST">
                      <a href="posts.html" class="list-group-item"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span><input type="submit" value="Views Circulars"><span class="badge">#</span></a>
                  </form>
            </div>
            ...
            <!-- Website Overview -->
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h3 class="panel-title">Latest Circulars</h3>
                </div>
                <div class="panel-body">
                  <table class="table table-striped table-hover">
                      ...
                      <c:forEach var="c" items="${circulars}">
                <tr>
                    <td>${c.title}</td>
                    <td width="20%">${c.body}</td>
                    <td>${c.priority}</td>
                    <td width="20%">${c.files}</td>
                    <td>
                       <a href="viewcircularServlet?CircularID=${c.title}">View</a>
                    </td>
                 </tr>
                        </c:forEach>    
                    </table>
