              ...
              <div class="panel panel-default">
                   ...
                   <div class="panel-heading main-color-bg">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="quote" action="updatehodservlet" method="post">        
                            <div>
                               <label>ID : </label>
                              <input type="text" name="hid" value="${hid}"><br>
                            </div> 
                            <br>
                            <div
                                <label><b>Name : </b></label>
                              <input type="text" name="hname" value="${hname}"><br>
                            </div>
                            <br>
                            <div>
                                <label>Password : </label>
                              <input type="password" name="hpass"  value="${hpassword}"><br>
                            </div>  
                             <br>
                            <div>
                                <label>Phone No. : </label>
                              <input type="text"  name = "hphone"  value="${hphone}"><br>
                            </div>
                             <br>
                             <div>
                                 <label>Department : </label>
                              <input type="text"  name = "hdeptname" value="${hdeptname}"><br>
                            </div>
