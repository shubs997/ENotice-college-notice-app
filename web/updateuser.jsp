...
<body>
    ...
    <section id="main">
      <div class="container">
        <article id="main-col">
            <div class="dark">
                <div style="color: #e8491d">${msg}</div>
            <h3>UPDATE YOUR PROFILE</h3>
            <form class="quote" action="updateServlet" method="post">        
               <div>
                <input type="text" name="uname" value="${name}"><br>
              </div>  
              <div>
                  <input type="text" name="lname" value="${last}" placeholder="lastname"><br>
              </div>     
              <div>
              ...
              <div>   
                  <input type="email" name="email" value="${emailid}" placeholder="email"><br>
              </div>
              <div>
                  <input type="text" name="gender" value="${gend}" placeholder="gender"><br>
              </div>  
              <div>
                  <input type="text" name="dept" value="${dep}" placeholder="department"><br>
              </div> 
              <button class="button_1" type="submit">Update Profile</button>
          </form>
          </div>
        </article>
