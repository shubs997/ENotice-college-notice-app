...
<%
	...
	{
		response.sendRedirect("loginhodMVC.jsp");
	}
    %>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="updatehod.jsp" class="list-group-item"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Update My Profile <span class="badge">#</span></a>
              <a href="circularpublish.jsp" class="list-group-item"><span class="glyphicon glyphicon-file" aria-hidden="true"></span> Add Circulars  <span class="badge">#</span></a>
