              ...
              <div class="panel panel-default">
                   ...
                   <div class="panel-heading main-color-bg">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="quote" action="updatestudentservlet" method="post">        
                            <div>
                               <label>First Name : </label>
                              <input type="text" name="sid" value="${name}"><br>
                            </div> 
                            <br>
                            <div
                                <label><b>Last Name :  </b></label>
                              <input type="text" name="sname" value="${last}"><br>
                            </div>
                            <br>
                            <div>
                                <label>Password :   </label>
                              <input type="password" name="spass"  value="${pass}"><br>
                            </div>  
                             <br>
                            <div>
                                <label>Email :      </label>
                              <input type="text"  name = "sclass"  value="${emailid}"><br>
                            </div>

                             <br>
                            <div>
                                <label>Phone No. : </label>
                              <input type="text"  name = "sphone"  value="${gend}"><br>
                            </div>
                             
                            <br>
                            <div>
                                <label>Department. : </label>
                              <input type="text"  name = "sdept"  value="${dept}"><br>
                            </div>
