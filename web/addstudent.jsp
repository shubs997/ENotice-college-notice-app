              ...
              <div class="panel panel-default">
                   ...
                   <div class="panel-heading main-color-bg">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="quote" action="addStudentServlet" method="post">        
                            <div>
                              <input type="text" name="sid" placeholder="userid"><br>
                            </div> 
                            <br>
                            <div>
                              <input type="text" name="sfname" placeholder="fname"><br>
                            </div>
                            <br>
                            <div>
                              <input type="text" name="slname" placeholder="lname"><br>
                            </div>
                            <br>
                            <div>
                              <input type="password" name="spass" placeholder="password"><br>
                            </div>  
                             <br>
                            <div>
