CREATE DATABASE  IF NOT EXISTS `testapp` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `testapp`;
...
INSERT INTO `circular` VALUES ('testc','testcircular','High','circular.jpg'),('shantanu','abc','Medium','WhatsApp Image 2018-08-27 at 12.03.32 AM (1).jpeg'),('bunny','test','Low','Lifecode Proteomics.pdf'),('MEETING CIRCULAR','meeting on monday','Medium','WhatsApp Image 2018-07-19 at 10.38.49 AM (1).jpeg'),('abc2141','test','Medium','Screenshot (27).png'),('bunny','test3','Medium','WhatsApp Image 2018-08-27 at 12.03.32 AM (1).jpeg'),('','','High','WhatsApp Image 2018-08-27 at 12.03.32 AM (1).jpeg'),('shantanu16','do MIS','Medium','WhatsApp Image 2018-07-19 at 10.38.49 AM (1).jpeg');
...
INSERT INTO `circular_staff` VALUES ('Assignment Notice','test','Medium','WhatsApp Image 2018-08-27 at 12.03.32 AM (1).jpeg'),('Holiday Notice','test2','Medium','Screenshot (54).png'),('asd','asdasd','High','Screenshot (9).png'),('shantanu','test23423r','Medium','WhatsApp Image 2018-07-19 at 10.38.49 AM (1).jpeg'),('assignment142','abc','Medium','Screenshot (11).png'),('assignment not done','test','Medium','CRB(10).pdf'),('test2323','test','High','WhatsApp Image 2018-07-19 at 10.38.49 AM(1).jpeg');
...
INSERT INTO `hod` VALUES ('1','hod1','name','123','IT'),('2','abc','123',NULL,NULL),('3','hod3','test',NULL,NULL),(NULL,NULL,NULL,NULL,NULL),('4','hod4','hod4',NULL,NULL);
...
INSERT INTO `newuser` VALUES (1,'shubham','jadhav','abc','shubhamjadhav5678@gmail.com','77690995221','Information Technology'),(2,'avinash','jannu','123','avinash43@gmail.com','Male','Information Technology'),(3,'mihir','nevpurkar','123','m@gmial.com','Male','Information Technology'),(4,'shantanu',NULL,'123',NULL,NULL,NULL);
...
INSERT INTO `notice_views` VALUES ('test100',''),('testfinal',',avinash,shubham,shantanu'),('finaltest100',',shantanu,shubham,avinash,mihir'),('text',',shubham'),('text2',',shubham'),('text3','');
...
-- Dump completed on 2018-10-19 11:01:16
