 ...
 * @author Shubham
 */
@WebServlet(name = "viewcircularServlet", urlPatterns = {"/viewcircularServlet"})
public class viewcircularServlet extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
    {
        ...
        List viewc;
        viewc = DaoMVC.viewCircular(CircularID);
