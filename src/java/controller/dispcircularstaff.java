...
@WebServlet(urlPatterns = {"/dispcircularstaff"})
public class dispcircularstaff extends HttpServlet {
...
//        nlist = DaoMVC.displayNotice(ub);
        ...
        List circulars;
        circulars = DaoMVC.displayStaffCircular();
        ...
        response.sendRedirect("viewstaffcirculartable.jsp");
//		try 
//		{                                                
//                     
//			if()
